...
compile({
    ...
    outfile: './resources/dist/filament-single-record-resource.js',
}).then(() => {
    console.log(`Build completed for filament-single-record-resource.js`)
})

compile({
    ...defaultOptions,
    entryPoints: ['./resources/css/index.css'],
    outfile: './resources/dist/filament-single-record-resource.css',
    loader: {
        '.css': 'css',
    },
}).then(() => {
    console.log(`Build completed for filament-single-record-resource.css`)
})
